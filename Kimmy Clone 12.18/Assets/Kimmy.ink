...
EXTERNAL place_actor_full (pos0, pos1)
EXTERNAL which_actor (sprite, ID) 
...
=== KMom1
{place_actor_full ("Dana", "KimmyMom")}
{which_actor ("Dana", 0)}
{which_actor ("KimmyMom", 1)}
...
+ [I'll be here first thing!] 
    I'll be here first thing! Wow, I didn’t expect to land a job today. Thanks so much! 
   ->goodbye
...
Kimmy: My mommy’s not inside. She left already. -> what_to_do
=what_to_do
*[Oh.]
...
{place_actor_full ("Kimmy", "Dean")}
{which_actor ("Kimmy", 0)}
{which_actor ("Dean", 1)}
Kimmy: My mom pays Dana a quarter a day.
+[That's right!] ->clerk_intro_next1

=clerk_intro_next1
{place_actor_full ("Dana", "Dean")}
{which_actor ("Dana", 0)}
{which_actor ("Dean", 1)}
Dana: I’m here to buy some things… I mean, I haven’t gotten paid yet. This is my first day. But I have some money saved up!
...
+ [So what did you spend all your money on?] ->clerk_intro_next2
=clerk_intro_next2
Dana: Your sewing classes?
...
Donna: She should probably stay on her porch. We’re the same age, but my mom takes me everywhere so I won’t get lost. I bet Kimmy would get lost if she wandered too far. ->playgamedonna
...
=hopscotch
{chalk: Okay let's play Hopscotch then.}
{chalk == false: ->nogamepieces} 
+ [Friends!] -> donna_taughtgame


=yahtzee
{dice: Okay let's play Yahtzee then.}
...
=== Anthony
{place_actor_full ("Dana", "Anthony")}
{which_actor ("Dana", 0)}
{which_actor ("Anthony", 1)}
Dana: Hey Anthony.
Anthony: Hi Dana. It’s so weird seeing you outside of school, haha.

{place_actor_full ("Dana", "Amber")}
{which_actor ("Dana", 0)}
{which_actor ("Amber", 1)}
Amber: I’m Amber!
...
{place_actor_full ("Amber", "Anthony")}
{which_actor ("Amber", 0)}
{which_actor ("Anthony", 1)}
...
{place_actor_full ("Kimmy", "Anthony")}
{which_actor ("Kimmy", 0)}
{which_actor ("Anthony", 1)}
...
* ...Mom[?], when I picked Kimmy up this morning, she had a rope tied around her. Is that… normal?
...
{which_actor ("Dana", 0)}
{which_actor ("Mom", 1)}
* I guess so[.]Dana: ... well, I'm definitely a better babysitter than a harness.
